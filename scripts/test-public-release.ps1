...
function Test-PublicRequiredLayout {
  ...
  $required = @(
    ...
    'docs/robot-factory-tutorial.md', 'docs/assets/robot-factory-showcase-preview.mp4',
    'docs/assets/robot-keyframes-contact.jpg', 'docs/assets/robot-frame-opening.jpg',
    'docs/assets/robot-frame-evidence.jpg', 'docs/assets/robot-frame-ending.jpg',
